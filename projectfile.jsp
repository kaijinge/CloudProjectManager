...
<body>
  ...
  <div class="MyProject" id="MyProject">
    <div class="filespace">
            ...
            <table class="filespacetable table table-hover">
            <thead>
            <tr> <th>文件ID</th><th>文件名</th><th>上传者</th><th>上传时间</th><th>操作</th></tr>
            </thead>
           <tbody>
            <c:forEach  items="${filelist}" var="a">
            <tr><th>${a.f_id}</th><th>${a.fanme}</th><th>${a.username}</th><th>${fn:substring(a.fdate,0,11)}</th>
            <th><a href="${pageContext.request.contextPath}/down?file=downByJsmart&F_id=${a.f_id}">下载</a>
            <a href="deletefile?f_id=${a.f_id}">删除</a></th></tr></c:forEach>
            </tbody></table></div>   	
  </div>
	</div>
