...
<body>
	<div class="wrap">
	    ...
	    <div class="MyProject" id="MyProject">
	    	<div class="MyProjectHeader">
	         ...
	         <form  action="createtask" id="createtaskform" onsubmit="return dosubmit()">
		        <div class="create-task">
		            <div class="create-task-input">
			            <input type="text" name="TNAME" class="taskname" placeholder="请输入任务名">
						<input type="text" name="DESCRIPTION" class="taskdetail hidden" placeholder="请输入项目描述">
					</div>
					<p style="float:left;margin-left:10px;">日期：<input type="text" id="datepicker" name="ENDDATE" style="height:30px;margin-top:30px;margin-right:10px;" readonly></p>
					...
					<input type="submit" class="btn btn-success create-task-confirm" value="提交" id="create-task-confirm"/>
				</div>
			</form>
  	 ...
  	 $(function() {
    	...
    	$("#createtaskform").validate({
			    ...
			    messages: {
			      TNAME: {
			        required: "请输入任务名",
			        minlength: "任务名至少由2个字符组成",
			        maxlength: "任务名最多不能超过10个字符"
			      },
			      REALNAME: {
			      	required:"请输入任务描述",
			        minlength: "任务描述最少由1个字符组成",
			        maxlength: "任务描述最多不能超过100个字符"
			      },
			      ENDDATE : {
			      	required:"请选择任务截止日期！"
			      }
  ...
  <script>
  	 function dosubmit(){
     //获取表单提交按钮
     var btnSubmit = document.getElementById("create-task-confirm");
